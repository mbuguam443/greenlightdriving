      ...
      >
        ...
        >
          <View style={styles.brand}>
            ...
            <Text style={styles.brandName}>Green Light Admin</Text>
            <Text style={styles.brandTagline}>Staff Portal</Text>
          </View>

          <View style={styles.formCard}>
            <Text style={styles.formTitle}>Welcome back</Text>
            <Text style={styles.formSubtitle}>Log in to access the admin dashboard</Text>
            ...
            <FormInput
              ...
              placeholder="admin@greenlight.co.ke"
            />
            <FormInput
              label="Password"
              value={password}
