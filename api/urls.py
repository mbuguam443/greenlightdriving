...
urlpatterns = [
    ...
    path('admin/lessons/<int:pk>/complete/', views.AdminLessonApproveView.as_view(), {'action': 'complete'}, name='admin_lesson_complete'),
    path('admin/documents/', views.AdminDocumentsView.as_view(), name='admin_documents'),
    path('admin/documents/<int:pk>/', views.AdminDocumentDetailView.as_view(), name='admin_document_detail'),
    path('admin/inquiries/', views.AdminEnquiriesView.as_view(), name='admin_inquiries'),
    path('admin/inquiries/<int:pk>/<str:action>/', views.AdminEnquiryActionView.as_view(), name='admin_enquiry_action'),
