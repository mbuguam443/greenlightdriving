...
urlpatterns = [
    ...
    path('lesson-request/', views.StudentLessonRequestView.as_view(), name='lesson_request'),
    ...
    path('manage/lesson-approval/<int:pk>/', views.ApproveLessonView.as_view(), name='approve_lesson'),
    path('manage/attendance-approve/<int:pk>/', views.ApproveAttendanceView.as_view(), name='approve_attendance'),
    path('manage/attendance-reject/<int:pk>/', views.RejectAttendanceView.as_view(), name='reject_attendance'),
