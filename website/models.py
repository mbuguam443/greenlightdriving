...
class Course(models.Model):
    ...
    full_course_price = models.DecimalField(max_digits=10, decimal_places=2, default=25000)
    half_course_price = models.DecimalField(max_digits=10, decimal_places=2, default=15000)
    test_only_price = models.DecimalField(max_digits=10, decimal_places=2, default=5000)
