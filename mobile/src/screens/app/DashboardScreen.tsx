...
export default function DashboardScreen({ navigation }: Props) {
  ...
  const quickActions = [
    { label: 'My Lessons', icon: 'car-outline' as const, color: colors.primary, screen: 'Lessons' as const },
    { label: 'Schedule', icon: 'calendar-outline' as const, color: colors.info, screen: 'Schedule' as const },
    { label: 'Progress', icon: 'trending-up-outline' as const, color: colors.warning, screen: 'Progress' as const },
    { label: 'Events', icon: 'megaphone-outline' as const, color: colors.red, screen: 'Events' as const },
    { label: 'Documents', icon: 'documents-outline' as const, color: '#8E24AA', screen: 'Documents' as const },
  ];
...
function makeStyles(colors: ThemeColors) {
  return StyleSheet.create({
    ...
    balanceLabel: { color: colors.onPrimary, opacity: 0.8, fontSize: 12, fontWeight: '600' },
    balanceValue: { color: colors.onPrimary, fontSize: 24, fontWeight: '800', marginTop: 4 },
    balanceMeta: { alignItems: 'flex-end' },
    balanceMetaText: { color: colors.onPrimary, opacity: 0.85, fontSize: 12, marginTop: 2 },
    actionsGrid: {
      flexDirection: 'row',
      flexWrap: 'wrap',
      gap: spacing.sm,
